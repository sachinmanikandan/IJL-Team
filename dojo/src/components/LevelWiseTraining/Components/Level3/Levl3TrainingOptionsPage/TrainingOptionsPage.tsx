...
import Levle3FileUploadComponent from "./FileUpload/FileUpload";
...
const Level3TrainingOptionsPage = () => {
  ...
  return (
    <>
      ...
      <div className="mx-auto p-6 pt-20">
        ...
        <Levle3FileUploadComponent />
      </div>
    </>
  );
};

export default Level3TrainingOptionsPage;