...
import { ChevronDown, ChevronUp, Zap, Trophy, CheckCircle, FileText, TrendingUp, Brain } from "lucide-react";
...
const Level3Component: React.FC = () => {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8000/api/question-papers/")
      .then(res => res.json())
      .then((data) => {
        const level3Papers = data.filter((p: QuestionPaper) => p.name.startsWith("Level 3"));
        ...
        <div className="text-center relative">
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-4">
              Master advanced concepts with expert-level assessments and complex challenges
            </p>
            <div className="flex items-center justify-center gap-2">
              <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium">Advanced</span>
              <span className="px-3 py-1 bg-violet-100 text-violet-700 rounded-full text-sm font-medium">Expert Level</span>
              <span className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm font-medium">Mastery</span>
            </div>
          </div>
        </div>
          ...
          <div className="relative bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/30">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Level 3 Progress</h3>
                  <p className="text-sm text-gray-600">Advanced expertise and mastery</p>
                </div>
              </div>
            ...
            {questionPapers.length === 0 ? (
              <div className="text-center py-16">
                <div className="relative mb-6">
                  <div className="w-24 h-24 mx-auto bg-gradient-to-r from-purple-200 to-indigo-200 rounded-full 
                                flex items-center justify-center shadow-lg">
                    <Trophy className="w-12 h-12 text-purple-600" />
                  </div>
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-r from-violet-400 to-purple-400 
                                rounded-full flex items-center justify-center shadow-lg">
                    <span className="text-white font-bold text-sm">3</span>
                  </div>
                </div>
                <h4 className="text-xl font-semibold text-gray-800 mb-2">No Level 3 Tests Available</h4>
                <p className="text-gray-600 max-w-md mx-auto">
                  Level 3 assessments are currently being prepared. Check back soon for advanced-level challenges!
                </p>
                <div className="mt-6 px-6 py-3 bg-gradient-to-r from-violet-100 to-purple-100 text-violet-700 
              ...
              <div className="space-y-6">
                {questionPapers.map((paper, index) => (
                  <div key={paper.id} 
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className="relative">
                          ...
                          <div className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-purple-500 to-violet-500 
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="p-2 bg-gradient-to-r from-violet-100 to-purple-100 rounded-full 
                    ...
                    {selectedPaperId === paper.id && (
                      <div className="border-t border-violet-200/50 bg-gradient-to-br from-violet-50/80 to-purple-50/80 
                                    backdrop-blur-sm p-6 space-y-6">
                        {questions.length === 0 ? (
                          <div className="text-center py-12">
                            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-violet-200 to-purple-200 
                                          rounded-full flex items-center justify-center shadow-lg">
                              ...
                              <div key={q.id} 
                                ...
                                <div className="flex items-start gap-4">
                                  <div className="flex-shrink-0">
                                    <div className="w-10 h-10 bg-gradient-to-r from-violet-500 to-purple-600 
